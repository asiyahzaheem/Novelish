...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"cart-index.js":[function(require,module,exports) {
"use strict";
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              confirmPassword = document.getElementById('confirmPassword-signup').value;
              _context.next = 8;
...
var forgotPasswordForm = document.querySelector('.resetPw');
...
if (resetForm) {
  resetForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var newPassword = document.getElementById('newPassword-reset').value;
    var confirmPassword = document.getElementById('confirmPassword-reset').value;
    var token = window.location.pathname.split('/')[2];
    (0, _updateSettings.resetPassword)(token, newPassword, confirmPassword);
  });
}
var popupBtn = document.querySelectorAll('.popup-btn');
var popupBtnArr = Array.from(popupBtn);
var loginFormEl = document.querySelector('.login-form');
var navMain = document.querySelector('.nav-books');
if (popupBtnArr) {
  popupBtnArr.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var popup = btn.id === 'forgotPw' ? 'forgotPwPopup' : 'signupPopup';
...
var closePopupBtn = document.querySelectorAll('.closePopup-btn');
var closePopupBtnArr = Array.from(closePopupBtn);
if (closePopupBtnArr) {
  closePopupBtnArr.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      e.preventDefault();
      var popup = btn.id === 'forgotPwSubmit' ? 'forgotPwPopup' : 'signupPopup';
...
var slideContainerEl = document.querySelector('.cards');
var slidePrevBtn = document.querySelector('.btn__slide-left');
var slideNextBtn = document.querySelector('.btn__slide-right');
if (slideContainerEl) {
  var containerDimensions = slideContainerEl.getBoundingClientRect();
...
var addToCartBtnArr = Array.from(addToCartBtn);
if (addToCartBtnArr) {
  addToCartBtnArr.forEach(function (btn) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 7:
                ...
                (0, _alerts.showAlert)('error', 'A maximum of 10 books can be added to the cart!', 3);
...
var removeFromCartBtnArr = Array.from(removeFromCartBtn);
if (removeFromCartBtnArr) {
  removeFromCartBtnArr.forEach(function (btn) {
    btn.addEventListener('click', /*#__PURE__*/function () {
...
var cartBtn = document.querySelector('.nav__link-cart');
if (cartBtn) {
  cartBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var cart = window.localStorage.getItem('cart');
    if (!cart) {
      (0, _alerts.showAlert)('error', 'Cart is empty!');
    } else {
      cart = JSON.parse(cart);
      console.log(cart);
      (0, _cartIndex.sendCart)(cart);
...
var orderBtn = document.getElementById('checkout');
if (orderBtn) {
  orderBtn.addEventListener('click', function (e) {
    e.target.textContent = 'Processing...';
    var cart = window.localStorage.getItem('cart');
    (0, _stripe.purchase)(JSON.parse(cart));
  });
}
},{"./login":"login.js","./stripe":"stripe.js","./cart-index":"cart-index.js","./signup":"signup.js","./updateSettings":"updateSettings.js","./alerts":"alerts.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
