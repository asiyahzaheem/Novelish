...
},{}],"cart-index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.sendCart = exports.removeFromCart = exports.addToCart = void 0;
...
var addToCart = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(bookId, cart) {
    var res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', "Successfully added book to cart!", 2);
            return _context.abrupt("return", res.data.newCart);
          case 7:
            _context.next = 12;
            break;
          case 9:
...
var removeFromCart = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(bookId, cart) {
    var removeAll,
      res,
      _args2 = arguments;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            removeAll = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 'none';
            _context2.prev = 1;
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'post',
          ...
          case 4:
            ...
            (0, _alerts.showAlert)('success', "Successfully removed book from cart!", 2);
            // window.setTimeout(() => {
            //   location.assign('/cart');
            // }, 1000);
            return _context2.abrupt("return", res.data.newCart);
          case 8:
            _context2.next = 13;
            break;
          case 10:
...
var sendCart = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(cart) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', _context3.t0.response.data.message, 2);
          case 11:
          case "end":
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Failed to log you in, try again!');
          case 10:
          case "end":
            return _context.stop();
        }
...
exports.updateSettings = exports.resetPassword = exports.forgotPassword = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'data' ? 'http://127.0.0.1:5000/api/v1/users/updateMe' : 'http://127.0.0.1:5000/api/v1/users/updateMyPassword';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'patch',
              url: url,
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type, " updated successfully!"), 3);
            }
            _context.next = 11;
            break;
          case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MCPfyEHSvBhKikvOJLQLxN9XetxOMZtkujO0g2T8A7NIeSGJcseT0Enq36T5HERP3GGG4tUAqSbyljqn6sPiHb600CdDtlj2O');
...
var _cartIndex = require("./cart-index");
...
if (signupform) {
  signupform.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var name, email, password, passwordConfirm, popupEl;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              passwordConfirm = document.getElementById('confirmPassword-signup').value;
              _context.next = 7;
              return (0, _signup.signup)(name, email, password, passwordConfirm);
            case 7:
              if (document.querySelector('.alert')) {
                popupEl = document.getElementById('signupPopup');
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              document.querySelector('.btn__save-password-form').textContent = 'Updating...';
              e.preventDefault();
            ...
            case 7:
              document.querySelector('.btn__save-password-form').textContent = 'Save password';
...
var getForgotPasswordForm = document.querySelector('.resetPw');
if (getForgotPasswordForm) {
  getForgotPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return (0, _updateSettings.forgotPassword)(email);
            case 5:
              document.querySelector('.forgotPwSubmit').innerHTML = 'Submit';
              if (document.querySelector('.alert')) {
                popupEl = document.getElementById('forgotPwPopup');
                popupEl.classList.remove('open-popup');
                loginFormEl.classList.remove('active');
                header.classList.remove('active');
              }
...
// reset password form
var getResetPasswordForm = document.querySelector('.reset');
if (getResetPasswordForm) {
  var token = window.location.pathname.substring(15);
  getResetPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              password = document.getElementById('newPassword-reset').value;
              passwordConfirm = document.getElementById('confirmPassword-reset').value;
              _context4.next = 5;
              return (0, _updateSettings.resetPassword)(token, password, passwordConfirm);
            case 5:
...
// logout
var logoutBtnEl = document.querySelector('.nav__logout');
if (logoutBtnEl) logoutBtnEl.addEventListener('click', _login.logout);

// activate popup
var btnActivateArr = Array.from(document.querySelectorAll('.popup-btn'));
var btnClosePopupArr = Array.from(document.querySelectorAll('.closePopup-btn'));
var header = document.querySelector('.nav-books');
btnActivateArr.forEach(function (btn) {
  btn.addEventListener('click', function () {
    var popupEl = document.getElementById(this.id === 'forgotPw' ? 'forgotPwPopup' : 'signupPopup');
    popupEl.classList.add('open-popup');
    loginFormEl.classList.add('active');
    header.classList.add('active');
  });
});
btnClosePopupArr.forEach(function (btn) {
  btn.addEventListener('click', function () {
    var popupEl = document.getElementById(this.id === 'forgotPwSubmit' ? 'forgotPwPopup' : 'signupPopup');
    popupEl.classList.remove('open-popup');
    loginFormEl.classList.remove('active');
    header.classList.remove('active');
  });
...
// slider
var container = _toConsumableArray(document.querySelectorAll('.cards'));
var nextBtn = document.querySelector('.btn__slide-right');
var prevBtn = document.querySelector('.btn__slide-left');
...
var btnAddToCartArr = Array.from(document.querySelectorAll('.addToCart'));
if (btnAddToCartArr) {
  btnAddToCartArr.forEach(function (btn) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                (0, _alerts.showAlert)('error', 'A maximum of 10 items can be added to your cart!');
              ...
              case 10:
                ...
                _context5.next = 13;
                return (0, _cartIndex.addToCart)(bookId, cart);
              case 13:
                cart = _context5.sent;
                window.localStorage.setItem('cart', JSON.stringify(cart));
                (0, _cartIndex.sendCart)(cart);
...
var btnRemoveFromCartArr = Array.from(document.querySelectorAll('.removeFromCart'));
if (btnRemoveFromCartArr) {
  btnRemoveFromCartArr.forEach(function (btn) {
    btn.addEventListener('click', /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.next = 6;
                return (0, _cartIndex.removeFromCart)(bookId, cart, 'all');
              case 6:
                cart = _context6.sent;
                if (!(cart.totalQty === 0)) {
                  _context6.next = 11;
              ...
              case 15:
                _context6.next = 17;
                return (0, _cartIndex.removeFromCart)(bookId, cart);
              case 17:
                cart = _context6.sent;
                if (cart.totalQty != 0) {
                  window.localStorage.setItem('cart', JSON.stringify(cart));
...
var navCartEl = document.querySelector('.nav__link-cart');
if (navCartEl) {
  navCartEl.addEventListener('click', function (e) {
    e.preventDefault();
    ...
    if (cart) {
      ...
      (0, _alerts.showAlert)('error', 'Cart is empty!', 3);
    }
  });
}
